...
del pietro_bros.o pietro_bros_MCLOAD.bin pietro_bros_LOADER.bin pietro_bros_NIRVANA_HOLE.bin > nul 2>&1
del pietro_scr.bin pietro_scr.bin.zx7 pietro_scr.tap pietro_bros_BANK_06.bin pietro_bros_BANK_06.bin.zx7 pietro_ay.tap > nul 2>&1
