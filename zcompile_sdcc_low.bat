...
zcc +zx -vn -zorg=%PADDR% -startup=31 -SO2 -clib=sdcc_iy --max-allocs-per-node3000 --opt-code-size --fsigned-char @zproject.lst -o pietro_bros -pragma-include:zpragma.inc
